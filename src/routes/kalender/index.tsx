...
const EVENTS = [
  {
    ...
    date: "2026-03-12",
    location: "Courtyard",
    description: "Öppen träning med svärd, sköld och rustning. Alla nivåer välkomna.",
  },
  {
    id: "2",
...
const selectedEvents = eventsByDay.get(selectedKey) ?? [];
  ...
  <div className="w-full flex flex-col lg:flex-row gap-8 items-start justify-center px-6 pb-10">
  {/* Calendar column */}
  ...
  <div className="w-full max-w-[420px]">
    ...
    {selectedEvents.length === 0 ? (
      <Card className="bg-[#f7ecd8] text-[#242424] shadow-lg border-2 border-[#1e325f]/35">
        <CardHeader>
          <CardTitle className="text-lg font-['Cormorant_SC']">Inga evenemang</CardTitle>
      ...
      <Card className="bg-[#f7ecd8] text-[#242424] shadow-lg border-2 border-[#1e325f]/35">
        <CardHeader>
          <CardTitle className="text-lg font-['Cormorant_SC']">{selectedEvents[0].title}</CardTitle>
